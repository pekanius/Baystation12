...
/obj/item/reagent_containers/food/snacks/concentrate/solid
	name = "concentrate"
...
/obj/item/reagent_containers/food/snacks/concentrate/solid/white
	name = "white solid concentrate"
	desc = "Tube of white solid concentrate. 20% nutritional value."
	con_color = "white"

/obj/item/reagent_containers/food/snacks/concentrate/solid/black
	name = "black solid concentrate"
	desc = "Tube of black solid concentrate. 40% nutritional value."
	con_color = "black"

/obj/item/reagent_containers/food/snacks/concentrate/solid/red
	name = "red solid concentrate"
	desc = "Tube of red solid concentrate. 60% nutritional value."
	con_color = "red"

// /obj/item/reagent_containers/food/snacks/concentrate/solid/red/On_Consume(var/mob/M)
