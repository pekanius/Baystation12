...
/obj/item/reagent_containers/food/snacks/concentrate/gel
	name = "concentrate"
...
/obj/item/reagent_containers/food/snacks/concentrate/gel/red
	name = "red gel concentrate"
	desc = "Tube of red gel concentrate."
	con_color = "red"

// /obj/item/reagent_containers/food/snacks/concentrate/gel/red/On_Consume(var/mob/M)
...
/obj/item/reagent_containers/food/snacks/concentrate/gel/green
	name = "green gel concentrate"
	desc = "Tube of green gel concentrate."
	con_color = "green"

/obj/item/reagent_containers/food/snacks/concentrate/gel/blue
	name = "blue gel concentrate"
	desc = "Tube of blue gel concentrate."
	con_color = "blue"

/obj/item/reagent_containers/food/snacks/concentrate/gel/yellow
	name = "yellow gel concentrate"
	desc = "Tube of yellow gel concentrate."
	con_color = "yellow"

/obj/item/reagent_containers/food/snacks/foodbricket
	name = "food bricket"
	desc = "���-�� ���������. ��������."
