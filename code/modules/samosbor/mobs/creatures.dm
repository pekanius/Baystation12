...
/mob/living/simple_animal/melee/samosbor/death(gibbed, deathmessage, show_dead_message)
...
/mob/living/simple_animal/melee/samosbor/kosti
	name = "hairy bones"
	desc = "�������&#255; �������. ������ ���&#255;��."
	icon_living = "heavy"
	speak_chance = 0
...
/mob/living/simple_animal/melee/samosbor/kosti/Finish()
	return
