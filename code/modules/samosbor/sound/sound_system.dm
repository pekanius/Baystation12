...
by Vallat special gift for Stalker Project.

*/

#define AMBIENT_CHANNELS_MIN 924
...
*/
sound_system/proc/PlayMusic(songfile, volume = 100)
...
sound_system/proc/AlterMusic(newsong, increments=20, time=increments)
	if(!src.current_music)
		...
		src.MusicFade(0, 100, increments, time)
		return
	...
	src.MusicFade(100, 0, increments, time)
